...
public class GiveClearEffectCommand extends ToolBoxBaseCommand {

    public GiveClearEffectCommand(@NotNull ToolBoxPlugin plugin, @NotNull String name, @NotNull String description,
    ...
    public boolean execute(@NotNull CommandSender sender, @NotNull String commandLabel, @NotNull String[] args) {
        if (sender instanceof Player) {
            ...
            player.getInventory().addItem(ClearEffect.createItemStack());
            return true;
        }
        return false;
    }
